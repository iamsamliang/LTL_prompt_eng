import pickle
import torch
from transformers import T5ForConditionalGeneration, T5Config, T5Tokenizer, Trainer, TrainingArguments
...
class T5PromptTuning(T5ForConditionalGeneration):
    ...
    def forward(self, input_ids, attention_mask=None):
        ...
        return super().forward(inputs_embeds=prompt_inputs_embedded, attention_mask=attention_mask)
...
if __name__ == '__main__':
    ...
    config = T5Config.from_pretrained("google/flan-t5-xxl")
    ...
    model = T5PromptTuning.from_pretrained("google/flan-t5-xxl", config=config, prompt_length=20)
